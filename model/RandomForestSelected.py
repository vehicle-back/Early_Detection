...
def main(args):
    ...
    print('*'*60, args.link_id)
    for i in range(train_XY[1].shape[1]):
        train_RF(train_X, test_X, train_Y[:, i, 3], test_Y[:, i, 3])
...
def gbm_create_parser():
    ...
    parser.add_argument('--number_of_business_day', type=int, default =260
                       # 260
