...
def main(args):
    ...
    for i in range(train_XY[1].shape[1]):
        SVM(train_X, test_X, train_Y[:, i, 3], test_Y[:, i, 3])
...
def gbm_create_parser():
    ...
    parser.add_argument('--link_id', type=str, default ='110+04483' # '104-04540' #'110N04483' #'110+04484' #'110-04482' #'110+04483' # '110P04483' #
